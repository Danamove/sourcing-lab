#!/usr/bin/env python3
"""
Sourcing Lab — first-run setup wizard.
...
╔══════════════════════════════════════════════════════════╗
║                                                          ║
║    SOURCING LAB — First-Run Setup                        ║
║                                                          ║
║    Track top reels across recruiting & career creators.  ║
...
def main():
  ...
  Next steps:
    ...
    4. Enable GitHub Pages (one time):
         ...
         # The site auto-redeploys after every scheduled refresh push.
